...
<body>
	...
	<div class="container">
		...
		<select name="userIds" id="userIds">
			<c:forEach var="emp" items="${userIds}">
  <option value="${emp}">${emp}</option>
</c:forEach>
  
</select>
<button id="search">SearchAccessDetails</button>
	</div>
	<p></p>
	<p> </p>
	<p></p>
...
<div class="container text-center"><h3>Access Details</h3></div>
	<div class="container">
		<div class="row">
			<div class="col-sm">
				<b>Doctor Section</b> <br></br>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="doc_show_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Show Flag</label>
				</div>

				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="doc_create_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Create Flag</label>
				</div>


				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="doc_delete_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Delete Flag</label>
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="doc_update_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Update Flag</label>
				</div>
			</div>
			<div class="col-sm">
				<b>Appointments Section</b> <br></br>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="app_show_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Show Flag</label>
				</div>

				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="app_create_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Create Flag</label>
				</div>
				...
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="app_delete_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Delete Flag</label>
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="app_update_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Update Flag</label>
				</div>
			...
			<div class="col-sm">
				<b>Patient Section</b> <br></br>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="pat_show_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Show Flag</label>
				</div>

				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="pat_create_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Create Flag</label>
				</div>
				...
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="pat_delete_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Delete Flag</label>
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="pat_update_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Update Flag</label>
				</div>
			...
			<!-- <div class="col-sm">
				<b>Medicine Section</b> <br></br>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="med_show_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Show Flag</label>
				</div>

				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="med_create_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Create Flag</label>
				</div>
				...
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="med_delete_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Delete Flag</label>
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="med_update_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Update Flag</label>
				</div>
			</div>
			<div class="col-sm">
				<b>Visiting Doctor Section</b> <br></br>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="vDoc_show_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Show Flag</label>
				</div>

				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="vDoc_create_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Create Flag</label>
				</div>
				...
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="vDoc_delete_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Delete Flag</label>
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="vDoc_update_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Update Flag</label>
				</div>
			</div> -->
		...
		<div class="row">
			...
			<div class="col-sm">
				<b>Emergency Section</b>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="icu_show_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Show Flag</label>
				</div>

				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="icu_create_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Create Flag</label>
				</div>
				...
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="icu_delete_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Delete Flag</label>
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" role="switch"
						id="icu_update_flag"> <label class="form-check-label"
						for="flexSwitchCheckDefault">Update Flag</label>
				</div>
			</div>
		</div>
...
$("#search").click(function(){
   var url="getUserInfo/"+$("#userIds").val();

	//get ajax call
	$.get(url, function(data, status){
	console.log('inside ajax get',data);
	  myReq.userName=data.userName;
      myReq.role=data.role;
      myReq.name=data.name;
      myReq.email=data.email;
